...
public class ProcessUtil {
     ...
     * @param jcVariableDecl 字段的语法树节点
     * @return 方法参数的语法树节点
     */
    static JCTree.JCVariableDecl cloneJCVariableDeclAsParam(TreeMaker treeMaker, JCTree.JCVariableDecl jcVariableDecl) {
     ...
     * 批量复制
     * @param treeMaker      语法树构造器
     * @param jcVariableDecls 字段的语法树节点
     * @return 方法参数的语法树节点
     */
    static List<JCTree.JCVariableDecl> JCVariableDeclAsParams(TreeMaker treeMaker, List<JCTree.JCVariableDecl> jcVariableDecls) {
        ListBuffer<JCTree.JCVariableDecl> jcVariables = new ListBuffer<>();
        for (JCTree.JCVariableDecl jcVariable : jcVariableDecls) {
            jcVariables.append(cloneJCVariableDeclAsParam(treeMaker, jcVariable));
        }
